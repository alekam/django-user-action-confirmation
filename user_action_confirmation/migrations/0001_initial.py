...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'confirmation_confirmation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['i_users.User'])),
        ...
        db.send_create_signal(u'confirmation', ['Confirmation'])


    def backwards(self, orm):
        # Deleting model 'Confirmation'
        db.delete_table(u'confirmation_confirmation')
    ...
    models = {
        ...
        u'confirmation.confirmation': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['i_users.User']"})
        },
